...
(function (t) {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        stop: function (e) {
            var i = t(this).data("ui-resizable"), s = i.options, o = i._proportionallyResizeElements, n = o.length && /textarea/i.test(o[0].nodeName), r = n && t.ui.hasScroll(o[0], "left") ? 0 : i.sizeDiff.height, a = n ? 0 : i.sizeDiff.width, h = {
                width: i.size.width - a,
                height: i.size.height - r
            }, l = parseInt(i.element.css("left"), 10) + (i.position.left - i.originalPosition.left) || null, p = parseInt(i.element.css("top"), 10) + (i.position.top - i.originalPosition.top) || null;
        ...
        start: function () {
            ...
            var i, s, o, n, r = t(this).data("ui-resizable"), a = r.options, h = r.containerOffset, l = r.position, p = r._aspectRatio || e.shiftKey, c = {
                top: 0,
                left: 0
...
(function (t) {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _refreshItems: function (e) {
            ...
            var i, s, n, o, r, a, h, l, c = this.items, p = [[t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {item: this.currentItem}) : t(this.options.items, this.element), this]], u = this._connectWith();
